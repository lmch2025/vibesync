      ...
      >
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="hidden sm:inline-flex items-center gap-1.5 rounded-full px-4 py-2 text-sm font-medium text-white/60 hover:text-white bg-white/5 backdrop-blur-md active:bg-white/10 transition-all min-h-[44px]"
          >
            Admin
          </button>
          <button
