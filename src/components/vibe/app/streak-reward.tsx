        ...
        {open && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative w-full max-w-sm rounded-3xl v-surface-solid ring-1 ring-white/10 p-6 shadow-2xl"
              ...
              {justClaimed ? (
                ...
                <>
                  ...
                  <div className="text-center mb-4">
                    ...
                    <p className="text-xs text-white/70 mt-0.5">Record: {data.streakMax} jours</p>
                  </div>
                            ...
                            className={`grid place-items-center h-9 w-9 rounded-full text-xs font-bold transition ${
                              isClaimed
                                ...
                                : isToday && data.canClaim
                                  ...
                                  : "v-surface-1 text-white/70 ring-1 ring-white/10"
                            }`}
                          >
                            {isClaimed ? <Check className="h-4 w-4" /> : r.day}
                          </motion.div>
                          <span className={`text-[8px] tabular-nums ${isClaimed ? "text-amber-300" : "text-white/70"}`}>
                            +{r.reward}
                          </span>
                        </div>
                      );
                  ...
                  {data.canClaim ? (
                    ...
                    <div className="w-full h-12 rounded-2xl v-surface-1 ring-1 ring-white/10 flex items-center justify-center gap-2 text-sm text-white/70">
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        exit={{ scale: 0.85, opacity: 0, y: 20 }}
        transition={{ type: "spring", stiffness: 300, damping: 25 }}
        className="relative w-full max-w-sm rounded-3xl v-surface-solid ring-1 ring-white/10 p-6 shadow-2xl overflow-hidden"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Glow background */}
        ...
        <div className="grid grid-cols-3 gap-2 mb-4">
          <button
            ...
            className="flex flex-col items-center gap-1 rounded-2xl v-surface-1 ring-1 ring-white/10 p-3 hover:v-surface-2 transition active:scale-95"
          >
          ...
          >
            ...
            <span className="text-[10px] text-white/70">Twitter / X</span>
          </button>
        </div>
        ...
        <button
          onClick={copyLink}
          className="w-full h-10 rounded-2xl v-surface-1 ring-1 ring-white/10 flex items-center justify-center gap-2 text-sm text-white/70 hover:v-surface-2 transition mb-3"
        >
          {copied ? (
