    ...
    <AnimatePresence>
      {match && (
        ...
        >
          ...
          <button onClick={onClose} className="absolute top-10 right-5 z-10 h-9 w-9 grid place-items-center rounded-full bg-white/15 backdrop-blur text-white">
            <X className="h-5 w-5" />
          </button>
          ...
          <div className="relative z-10 text-center px-6">
            ...
            <div className="flex flex-col gap-2.5 max-w-[220px] mx-auto">
              ...
              <button
                onClick={onClose}
                className="h-11 rounded-2xl bg-white/15 backdrop-blur text-white font-semibold active:scale-95 transition"
              >
                Continuer à swiper
              </button>
            </div>
