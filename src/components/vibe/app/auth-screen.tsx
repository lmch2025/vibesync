  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-20 -right-20 h-64 w-64 rounded-full bg-accent/30 blur-3xl animate-float-slow" style={{ animationDelay: "2s" }} />
      </div>
        ...
        <AnimatePresence mode="wait">
            ...
            <motion.div key="phone" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -16 }} className="flex-1 flex flex-col">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 h-12 rounded-2xl bg-white/80 text-base"
          ...
          {step === "otp" && (
            <motion.div key="otp" initial={{ opacity: 0, x: 24 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -24 }} className="flex-1 flex flex-col">
              <button onClick={() => setStep("phone")} className="self-start mb-4 text-sm text-muted-foreground flex items-center gap-1">
          ...
          {step === "pin-confirm" && (
            <motion.div key="pin-confirm" initial={{ opacity: 0, x: 24 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -24 }} className="flex-1 flex flex-col">
              <button onClick={() => setStep("pin-create")} className="self-start mb-4 text-sm text-muted-foreground flex items-center gap-1">
                <ArrowLeft className="h-4 w-4" /> Retour
              </button>
              <h2 className="font-display text-2xl font-bold text-center mb-2">Confirme ton PIN</h2>
              <p className="text-sm text-muted-foreground text-center mb-8">Retape les 4 chiffres.</p>
              <div className="flex justify-center">
                <InputOTP
                  maxLength={4}
                  value={confirmPin}
          ...
          {step === "pin-login" && (
            <motion.div key="pin-login" initial={{ opacity: 0, x: 24 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -24 }} className="flex-1 flex flex-col">
              <button onClick={() => setStep("otp")} className="self-start mb-4 text-sm text-muted-foreground flex items-center gap-1">
                <ArrowLeft className="h-4 w-4" /> Retour
              </button>
