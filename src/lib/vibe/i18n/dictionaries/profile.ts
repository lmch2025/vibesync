...
export const profile = defineDict(
  {
    ...
    // ── LikesViewer — « Voir mes Likes » : fenêtre d'accès persistante ──────
    "likes.title": "Ils t'ont liké",
    "likes.sub": "Ils t'ont déjà liké — un Like en retour = match instantané",
    "likes.discreetAria": "Voir mes likes — accès en cours",
    "likes.count.one": "1 like reçu",
    "likes.count.many": "{{n}} likes reçus",
    "likes.chip.superlike": "Super-Like ⭐",
    "likes.chip.like": "Like ❤️",
    "likes.matched": "Matché ✓",
    "likes.likedBack": "Liké ✓",
    "likes.passed": "Passé",
    "likes.openChat": "Discuter",
    "likes.hint": "💡 Like en retour = match instantané ⚡",
    "likes.empty.title": "Aucun like pour l'instant",
    "likes.empty.sub": "Reviens plus tard — ton profil plaît forcément à quelqu'un 😉",
    "likes.expired.title": "Accès expiré",
    "likes.expired.sub": "Ton accès à la liste des likes vient de se terminer",
    "likes.expired.cta": "Prolonger l'accès",
    "likes.gridAria": "Liste des profils qui t'ont liké",
    "likes.loading": "Chargement de tes likes…",
  ...
  },
  {
    ...
    // ── LikesViewer — "See my Likes": persistent access window ───────────
    "likes.title": "They liked you",
    "likes.sub": "They already liked you — a like back is an instant match",
    "likes.discreetAria": "See my likes — access active",
    "likes.count.one": "1 like received",
    "likes.count.many": "{{n}} likes received",
    "likes.chip.superlike": "Super-Like ⭐",
    "likes.chip.like": "Like ❤️",
    "likes.matched": "Matched ✓",
    "likes.likedBack": "Liked ✓",
    "likes.passed": "Passed",
    "likes.openChat": "Chat",
    "likes.hint": "💡 Like back = instant match ⚡",
    "likes.empty.title": "No likes yet",
    "likes.empty.sub": "Check back later — someone out there already likes you 😉",
    "likes.expired.title": "Access expired",
    "likes.expired.sub": "Your access to the likes list just ended",
    "likes.expired.cta": "Extend access",
    "likes.gridAria": "List of profiles who liked you",
    "likes.loading": "Loading your likes…",
